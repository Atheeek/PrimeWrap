    ...
    <section className="py-24 px-4 md:px-8 bg-white overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex items-center gap-4 mb-16">
          ...
          <h2 
            className="text-3xl md:text-4xl font-semibold text-navy tracking-tight uppercase"
          >
            Check Our Work
          </h2>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col h-full justify-between order-2 lg:order-1">
            <div>
              ...
              <h3 
                className="text-4xl lg:text-5xl font-semibold text-navy leading-[1.1] mb-6"
              >
                {activeProject.title}
              </h3>
