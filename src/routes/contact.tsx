...
import { UploadCloud, Check, ArrowRight, MapPin, Mail, Phone } from "lucide-react";

export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Yalla Wrap It" },
      { name: "description", content: "Reach the Yalla Wrap It studio in Dubai — request a quote or book a site visit." },
      { property: "og:title", content: "Contact Yalla Wrap It" },
      { property: "og:description", content: "Request a quote or book a site visit." },
    ],
  }),
  component: Contact,
});
...
const MobileContactView = ({ 
  ...
  <div className="block lg:hidden w-full pt-12 pb-20">
    {/* Header */}
    ...
    <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(20,35,70,0.08)] overflow-hidden border border-gray-100 flex flex-col">
      ...
      <div className="bg-[#142346] p-6 sm:p-8 text-white">
        ...
        <div className="space-y-5">
          ...
          <div>
            <label className="block text-[10px] font-medium text-gray-400 uppercase tracking-wider mb-1">Message</label>
            <textarea 
              rows={3}
              placeholder="How can we help?"
              className="w-full bg-transparent border-b border-gray-600 pb-2 text-white placeholder-gray-500 focus:outline-none focus:border-orange-500 transition-colors rounded-none text-sm resize-none"
            />
          </div>
        </div>
      </div>
      ...
      <div className="p-6 sm:p-8">
        ...
        <h3 className="text-lg font-semibold text-[#142346] mb-3" style={raleway}>Project Media <span className="text-sm font-normal text-gray-400">(Optional)</span></h3>
        <label 
...
--------------------------------------------------------- */
const DesktopContactView = ({ 
  selectedServices, 
  toggleService, 
  isHoveringDrop, 
  setIsHoveringDrop 
}: any) => (
  <div className="hidden lg:grid grid-cols-12 gap-24 items-start w-full py-24">
    ...
    <div className="col-span-5 sticky top-32">
      ...
      <div className="space-y-4 max-w-sm">
        <div className="flex items-center gap-6 p-5 bg-[#efeeea] rounded-2xl">
          <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm flex-shrink-0">
            <Phone className="w-5 h-5 text-orange-500" />
          </div>
          <div>
            <p className="text-[#142346] font-bold text-sm">Direct Line</p>
            <p className="text-gray-500 text-xs mt-1">+971 50 000 0000</p>
          </div>
        </div>
        <div className="flex items-center gap-6 p-5 bg-[#efeeea] rounded-2xl">
          <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm flex-shrink-0">
          ...
          <div>
            <p className="text-[#142346] font-bold text-sm">Email Inquiries</p>
            <p className="text-gray-500 text-xs mt-1">hello@yallawrapit.ae</p>
          </div>
        </div>
        <div className="flex items-center gap-6 p-5 bg-[#efeeea] rounded-2xl">
          <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm flex-shrink-0">
          ...
          <div>
            <p className="text-[#142346] font-bold text-sm">Studio Location</p>
            <p className="text-gray-500 text-xs mt-1">Al Quoz, Dubai — UAE</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <form className="space-y-16">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="group relative col-span-2 mt-4">
              <textarea 
                id="desktop-message"
                rows={3}
                className="peer w-full bg-transparent border-b-2 border-gray-200 py-3 text-[#142346] placeholder-transparent focus:outline-none focus:border-orange-500 transition-colors rounded-none text-lg resize-none"
                placeholder="Message"
              />
              <label 
        ...
        <div>
          <div className="flex items-baseline gap-3 mb-8 border-b border-gray-200 pb-4">
            ...
            <h3 className="text-2xl font-bold text-[#142346]" style={raleway}>Project Media <span className="text-sm font-normal text-gray-400">(Optional)</span></h3>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="px-4 md:px-8 max-w-[1400px] mx-auto overflow-hidden">
        <MobileContactView {...stateProps} />
        <DesktopContactView {...stateProps} />
      </section>
